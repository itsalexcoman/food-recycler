...
class App extends Component {
  ...
  render() {
    ...
    if (
      ...
      !authStatus.doLogin &&
      !authStatus.doRegister
    ) {
      return (
        <Splash
          login={this.handleLogin}
          register={this.handleRegister}
          guest={this.handleDemo}
        />
      );
    }
    if (
      ...
      return (
        <Login toRegister={this.handleRegister} splash={this.handleSplash} />
      );
    }
    if (
      !authStatus.isAuthenticated &&
      ...
      return <Register toLogin={this.handleLogin} splash={this.handleSplash} />;
    }
